(function () {
  const state = {
    lang: localStorage.getItem("toshiba-canvio-lang") || "zh"
  };
  ...
  function renderProductDetail() {
    ...
    document.title = `${productName(product)} | Toshiba Canvio`;
      ...
      <section class="detail-hero">
        <div class="detail-copy">
          ...
          <div class="detail-actions">
            <strong>${product.price}</strong>
            <a class="primary-btn" href="mailto:hello@toshiba-canvio.example">${t("detail.contact")}</a>
          </div>
  ...
  function applyLanguage(lang) {
    state.lang = lang;
    localStorage.setItem("toshiba-canvio-lang", lang);
